...
export SAVE_QUANTIZED_PARAMS_PATH=gs://${USER}-bkt/checkpoints/quantized/test/${MODEL_NAME}-chat
...
python MaxText/decode.py \
  ...
  save_quantized_params_path=${SAVE_QUANTIZED_PARAMS_PATH} \
  load_quantized_params=false
