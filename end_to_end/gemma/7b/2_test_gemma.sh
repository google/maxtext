...
# 1. Run decoding, finetuning of Gemma 7B with the converted checkpoint. Also, run pretraining of Gemma 7B
...
python MaxText/generate_param_only_checkpoint.py MaxText/configs/base.yml base_output_directory=${BASE_OUTPUT_DIRECTORY} load_parameters_path=${CONVERTED_CHECKPOINT} run_name=${RUN_NAME} model_name='gemma-7b' force_unroll=true
...
# Ahead of Time Compilation (https://github.com/google/maxtext?tab=readme-ov-file#ahead-of-time-compilation-aot) command for Gemma 7B training on v5e-256.
