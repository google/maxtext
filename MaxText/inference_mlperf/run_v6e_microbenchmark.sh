...
# Look at profiles: 
# tensorboard --logdir /tmp/mb/profiles/trillium_lllama2_70b/tensorboard/prefill_insert_1024 
...
export PER_DEVICE_BATCH_SIZE=56
export RUN_DESC="${run_name}_${stages}_${prefill_lens}_flags_${enable_xla_flags}"
...
attention=dot_product base_output_directory="gs:/${USER}-bkt/profiles_mb" run_name=${RUN_DESC} \
